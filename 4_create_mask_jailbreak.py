...
class ModelAwareSteeringHook:
    def __init__(self, model_name, layer_name, steering_vector, alpha, top_k=6):
        ...
        self.alpha = alpha
        self.top_k = top_k  # Only relevant when the model outputs more than the logits, like DeepSeek MoE
...
if __name__ == "__main__":
    ...
    for exp in all_experiment_results:
        ...
        output_dir = os.path.join(root_folder, "results", "steered_responses_jailbreak", model_config.model_name)
